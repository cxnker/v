...
local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/sukunahub16-wq/library-Hexagon/refs/heads/main/library%20Hexagon.luau"))()
...
Tab2:AddToggle({
    Name = "bug togel ",
    Description = "دون اي نطاق او مجال",
    Default = false,
    Callback = function(state)
        attackEnabled = state
